...
// Render file list
function list(path) {
var content = `<div class="container" style="max-width: 65%;margin: 0px 165px;">${UI.fixed_header ?'<br>': ''}
<div id="update"></div>
...
function render_search_result_list() {
  var content = `
<div class="container" style="max-width: 65%;margin: 0px 165px;"><br>
<div class="card">
