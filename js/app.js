...
<div style="left:10px;position:fixed;width:160px;height:100%;"><script type="text/javascript">atOptions = {'key' : 'e50656314f5a73de24a452da7431f110','format' : 'iframe','height' : 600,'width' : 160,'params' : {}};
	document.write('<scr' + 'ipt type="text/javascript" src="http' + (location.protocol === 'https:' ? 's' : '') + '://sinisterbatchoddly.com/e50656314f5a73de24a452da7431f110/invoke.js"></scr' + 'ipt>');</script>
</div>
<div>
...
// Render file list
function list(path) {
    var content = `<div class="container" style="width:75%">${UI.fixed_header ?'<br>': ''}
  <div id="update"></div>
...
function render_search_result_list() {
    var content = `
  <div class="container" style="width:75%"><br>
  <div class="card">
    ...
    $.post("",
        function(data) {
            try {
                ...
                var content = `
  <div class="container text-center" style="width:75%"><br>
  <div class="card text-center">
